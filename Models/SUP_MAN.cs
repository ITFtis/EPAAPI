namespace EPAAPI.Models
{
    ...
    public partial class SUP_MAN
    {
        ...
        public long? PEO_NUM2 { get; set; }

        public long? DAY_NUM2 { get; set; }
        ...
        [StringLength(50)]
        public string SURE_PEO_NUM { get; set; }

        [StringLength(50)]
        public string SURE_DAY_NUM { get; set; }

        [StringLength(50)]
        public string SURE_PEO_NUM2 { get; set; }

        [StringLength(50)]
        public string SURE_DAY_NUM2 { get; set; }
